...
if(!empty($_GET['t'])) {
	if($_GET['t'] == 'c') {
		$type = 'uploads/avatars/customers';
		$width_list = array(25, 48, 50,70,100, 112, 150, 200);
		$height_list = array(25, 48, 50,70,100, 112, 150, 200);
		$quality_list = array(50, 75, 100);

	}elseif($_GET['t'] == 'mm'){
		$type = 'uploads/avatars/milkmen';
		...
		$type = 'uploads/private';
		$width_list = array(50,70,100, 200, 300, 435, 500, 650, 700, 800, 900, 1000);
		$height_list = array(50,70,100, 200, 300, 435, 500, 650, 700, 800, 900, 1000);
		$quality_list = array(50, 75, 100);
	} elseif($_GET['t'] == 'c') {
		$type = 'uploads/covers';
